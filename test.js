...
const libunqfy = require('./unqfy_service/unqfy');
...
function createAndAddTrack(unqfy, albumName, trackName, trackDuraction, trackGenre) {
  unqfy.addTrack(albumName, { name: trackName, duration: trackDuraction, genre: trackGenre });
...
describe('Add, remove and filter data', () => {
  ...
  it('should get all tracks matching genres', () => {
    ...
    const t1 = createAndAddTrack(unqfy, 'Appetite for Destruction', "Sweet Child o' Mine", 500, 'hard rock');
...
describe('Playlist Creation and properties', () => {
  ...
  it('should create a playlist as requested', () => {
    ...
    createAndAddArtist(unqfy, 'Michael Jackson', 'USA');
    createAndAddAlbum(unqfy, 'Michael Jackson', 'Thriller', 1987);
    const t2 = createAndAddTrack(unqfy, 'Thriller', 'Thriller', 200, 'movie');
